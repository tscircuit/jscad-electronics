...
test("sot89 body", async () => {
  const probe = probeFor("sot89")
  const height = nominalHeightFor("sot89")
  ...
  await expect(bottom).toMatchPngSnapshot(import.meta.path, "sot89-underside")
})
