...
test("led2835 body", async () => {
  const probe = probeFor("led2835")
  const height = nominalHeightFor("led2835")
  ...
  await expect(bottom).toMatchPngSnapshot(import.meta.path, "led2835-underside")
})
