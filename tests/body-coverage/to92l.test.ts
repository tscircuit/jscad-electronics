...
test("to92l body", async () => {
  const probe = probeFor("to92l")
  const height = nominalHeightFor("to92l")
  ...
  await expect(bottom).toMatchPngSnapshot(import.meta.path, "to92l-underside")
})
