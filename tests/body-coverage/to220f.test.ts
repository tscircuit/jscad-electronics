...
test("to220f body", async () => {
  const probe = probeFor("to220f")
  const height = nominalHeightFor("to220f")
  ...
  await expect(bottom).toMatchPngSnapshot(import.meta.path, "to220f-underside")
})
