...
test("sot343 body", async () => {
  const probe = probeFor("sot343")
  const height = nominalHeightFor("sot343")
  ...
  await expect(bottom).toMatchPngSnapshot(import.meta.path, "sot343-underside")
})
