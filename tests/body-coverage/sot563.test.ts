...
test("sot563 body", async () => {
  const probe = probeFor("sot563")
  const height = nominalHeightFor("sot563")
  ...
  await expect(bottom).toMatchPngSnapshot(import.meta.path, "sot563-underside")
})
