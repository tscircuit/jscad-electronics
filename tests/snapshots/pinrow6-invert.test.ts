...
test("6-pin header connector", async () => {
  const pngBuffer = await renderFootprint(
    "pinrow6_id01mm_p2.54mm_od01.6mm_invert",
    {
...
test("mounted on the underside from below", async () => {
  const footprint = "pinrow6_id01mm_p2.54mm_od01.6mm_invert"
