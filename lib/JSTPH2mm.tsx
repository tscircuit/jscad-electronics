...
/**
 * Parametric JST PH-style, side-entry through-hole connector.
 *
 * The pin and pad dimensions can be passed directly from a footprinter
 * definition so the model remains aligned with the generated land pattern.
 */
export const JSTPH2mm = ({
  ...
  const pinSpan = Math.max(numPins - 1, 0) * pitch
